...
//
// This file holds only the library-free half (the definitions, the labels and
// the classifier), so a client component can import the chip list without
// pulling the whole nerf library into its chunk. The precomputed id map lives
// in nerfCategories.ts, which re-exports everything here.
