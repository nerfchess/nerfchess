...
export const UPDATES: UpdateEntry[] = [
  {
    ...
    summary: "743 cards that duplicated, dominated or out-talked another card have left the draft pools. They still replay, and the codex shows them under a filter.",
