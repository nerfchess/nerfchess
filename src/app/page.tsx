...
// Ambient gold-dust star field behind the whole home page: three parallax
// dust layers (each a single node carrying a tiled speckle that drifts on a
// seamless loop), twelve 4-point brass glints that twinkle on offset beats,
// and two slow shooting stars (one pass roughly every 14s). Pure CSS —
// transform/opacity only, no JS loops, no canvas; 17 animated nodes total
// (10 on phones), pointer-events-none, fully stilled under reduced motion
// and dropped in perf mode / light theme. Styles live in globals.css under
// "Ambient gold-dust star field".
function StarField() {
