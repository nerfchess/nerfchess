...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    closing:
      "That move would be illegal in standard chess. Here, danger is allowed; capture is what ends the game. On top of this, a draft deals cards every 6 moves: hexes and boons in Nerf mode, buffs in Buff mode.",
  },
];
