...
import { isSpeedCategory, type SpeedCategory } from "@/lib/speed";

export const dynamic = "force-dynamic";

const DEFAULT_CATEGORY: SpeedCategory = "blitz";
...
// One leaderboard per rating category (UltraBullet/Bullet/Blitz/Rapid); the
...
export async function GET(request: Request) {
  ...
  const category: SpeedCategory = isSpeedCategory(requested) ? requested : DEFAULT_CATEGORY;
