      ...
      <section className="mx-auto max-w-6xl px-5 py-8 sm:px-6">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            <div className="skeleton h-8 w-48 max-w-full rounded-[10px]" style={{ borderRadius: 10 }} />
            <div className="skeleton mt-2 h-4 w-32 rounded-[10px]" style={{ borderRadius: 10 }} />
          </div>
        </div>
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          {Array.from({ length: 2 }).map((_, i) => (
            <div key={i} className="plate flex items-center gap-3 p-4">
              <div className="skeleton h-10 w-10 shrink-0 rounded-[10px]" style={{ borderRadius: 10 }} />
              <div className="min-w-0 flex-1">
                <div className="skeleton h-4 w-20 rounded-[10px]" style={{ borderRadius: 10 }} />
                <div className="skeleton mt-2 h-6 w-16 rounded-[10px]" style={{ borderRadius: 10 }} />
              </div>
            </div>
          ))}
        </div>
