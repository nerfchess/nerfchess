  ...
  return (
    <main className="min-h-screen pb-16">
      ...
      <section className="mx-auto max-w-6xl px-5 py-8 sm:px-6">
        <div className="skeleton h-10 w-40 rounded-[2px]" style={{ borderRadius: 2 }} />
        <div className="skeleton mt-2 h-4 w-72 max-w-full rounded-[2px]" style={{ borderRadius: 2 }} />
        <div className="skeleton mt-6 h-11 w-full rounded-[2px]" style={{ borderRadius: 2 }} />
        <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 9 }).map((_, i) => (
            <div key={i} className="plate p-4">
              <div className="skeleton h-5 w-2/3 rounded-[2px]" style={{ borderRadius: 2 }} />
              <div className="skeleton mt-2.5 h-3.5 w-full rounded-[2px]" style={{ borderRadius: 2 }} />
              <div className="skeleton mt-1.5 h-3.5 w-4/5 rounded-[2px]" style={{ borderRadius: 2 }} />
            </div>
          ))}
        </div>
      </section>
