...
const STUBS: Stub[] = [
  ...
  { id: "inching_forward", name: "Inching Forward", description: "After turn 6, king must be in front of home rank. Required rank advances every 6 turns.", tier: 6 },
  ...
  { id: "reflective", name: "Reflective", description: "Non-pawns must move to squares whose mirror across the center is occupied.", tier: 7 },
  ...
  { id: "bridge_over_troubled_water", name: "Bridge Over Troubled Water", description: "A river runs through the middle. Cross only via the center files.", tier: 6 },
  ...
  { id: "secret_garden", name: "Secret Garden", description: "Two of your pawns have secret gardens. Don't trespass.", tier: 6 },
  { id: "thunderdome", name: "Thunderdome", description: "Center 16 squares are the thunderdome. Pieces enter; pieces rarely leave.", tier: 6 },
  ...
  { id: "theocracy", name: "Theocracy", description: "On odd/even moves, can only capture with bishops.", tier: 5 },
