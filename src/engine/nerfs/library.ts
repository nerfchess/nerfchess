...
const STUBS: Stub[] = [
  ...
  { id: "crossing_the_rubicon", name: "Crossing the Rubicon", description: "Once a piece crosses to the opponent's half, it can't return.", tier: 4 },
  { id: "queen_disguise", name: "Queen Disguise", description: "Your queen is secretly either a rook or a bishop. Once you move it like one, you can't move it like the other.", tier: 4 },
  { id: "queen_bee", name: "Queen Bee", description: "Once you capture with your queen, you can no longer move queens.", tier: 2 },
  { id: "entrenched", name: "Entrenched", description: "Rooks can't move more than 2 squares.", tier: 5 },
  { id: "shadow_queen", name: "Shadow Queen", description: "Queen can only move to dark squares.", tier: 4 },
  ...
  { id: "separation_church_state", name: "Separation of Church and State", description: "Can't move bishops next to a king and can't move king next to a bishop.", tier: 3 },
  ...
  { id: "femme_fatale", name: "Femme Fatale", description: "You can only capture the enemy king with your queen.", tier: 5 },
  ...
  { id: "unspooling", name: "Unspooling", description: "Total move distance budget = 100. When you run out, you lose.", tier: 7 },
  { id: "evil_twin", name: "Evil Twin", description: "If you can capture a piece with a same-type piece, you must.", tier: 3 },
  { id: "doctor_octopus", name: "Doctor Octopus", description: "Can only capture non-king pieces 8 times total.", tier: 6 },
  ...
  { id: "stay_at_home_mom", name: "Stay-at-Home Mom", description: "Queen can only move to your two home ranks.", tier: 6 },
  ...
  { id: "shapeshifter", name: "Shapeshifter", description: "Queen starts as a bishop. When you capture a non-pawn, queen becomes a copy of that piece. Capturing a knight freezes her.", tier: 5 },
  { id: "conscientious_objectors", name: "Conscientious Objectors", description: "Can't capture with pawns.", tier: 4 },
  { id: "respectful", name: "Respectful", description: "Can't give check.", tier: 8 },
  { id: "horse_eats_first", name: "Horse Eats First", description: "As long as you have a knight, you can only capture with knights.", tier: 6 },
  ...
  { id: "windup_toys", name: "Windup Toys", description: "After move 12, can't move knights or bishops.", tier: 6 },
  ...
  { id: "control_center", name: "Control Center", description: "Non-capturing moves must go to files c, d, e, or f.", tier: 5 },
  { id: "haunted", name: "Haunted", description: "Can't move to a square where you've previously captured.", tier: 3 },
  { id: "tower_defense", name: "Tower Defense", description: "Can't move rooks. If you lose all rooks, you lose.", tier: 7 },
  ...
  { id: "triple_play", name: "Triple Play", description: "Can only capture the enemy king if you have 3 of a random piece type.", tier: 6 },
  ...
  { id: "torchlight", name: "Torchlight", description: "Non-pawns can only move if start or end square is adjacent to one of your pawns.", tier: 7 },
  { id: "turn_other_cheek", name: "Turn the Other Cheek", description: "Can't recapture.", tier: 6 },
  { id: "gambler", name: "Gambler", description: "Can't move a specific piece type, re-randomized each turn.", tier: 5 },
  { id: "blinded_by_sun", name: "Blinded by the Sun", description: "Can't end turn attacking a random square.", tier: 3 },
  { id: "bishop_fan_club", name: "Bishop Fan Club", description: "Must promote to bishops. King and queen can only move diagonally.", tier: 6 },
  { id: "chivalry", name: "Chivalry", description: "Can only capture heavies (rooks, queens) with a knight.", tier: 5 },
  ...
  { id: "moving_day", name: "Moving Day", description: "From your 20th move on, you lose if you have any piece on your back rank.", tier: 5 },
  ...
  { id: "social_distancing", name: "Social Distancing", description: "Can't make non-capturing moves to squares adjacent to opponent pieces.", tier: 6 },
  { id: "far_sighted", name: "Far Sighted", description: "Pieces can't capture pieces adjacent to them.", tier: 4 },
  { id: "drag", name: "Drag", description: "Your queen is now royal: if it is captured, you lose.", tier: 7 },
  { id: "stir_crazy", name: "Stir Crazy", description: "If you haven't moved your king for 4 turns, you must on the 5th.", tier: 4 },
  ...
  { id: "cheerleaders", name: "Cheerleaders", description: "Non-pawns can only capture if adjacent to one of your pawns.", tier: 6 },
  { id: "scouting_ahead", name: "Scouting Ahead", description: "As long as you have a pawn, non-pawns can't go ahead of your most advanced pawn.", tier: 5 },
  { id: "spice_of_life", name: "Spice of Life", description: "Can't move same piece type twice in a row.", tier: 3 },
  { id: "warlord", name: "Warlord", description: "From your 12th move on, you lose if your king is on either of your first two ranks.", tier: 5 },
  ...
  { id: "stand_your_ground", name: "Stand Your Ground", description: "One of your pieces may capture only while it is itself under attack by an enemy piece.", tier: 7 },

  // HARD
  { id: "always_check_it_might_be_mate", name: "Always Check, It Might Be Mate", description: "If you are checked, you lose.", tier: 8 },
  { id: "glorious_battle", name: "Glorious Battle", description: "Starting on a random move, for 4 consecutive moves, you must capture or lose.", tier: 6 },
  ...
  { id: "leveling_up", name: "Leveling Up", description: "Can't capture a piece type until you've captured its predecessor.", tier: 7 },
  ...
  { id: "eye_for_an_eye", name: "Eye for an Eye", description: "If opponent captures, you must capture next turn or lose.", tier: 7 },
  ...
  { id: "boastful", name: "Boastful", description: "Lose if you have fewer pieces than opponent.", tier: 8 },
  ...
  { id: "eat_your_vegetables", name: "Eat Your Vegetables", description: "Can't capture non-pawns until opponent has ≤ 4 pawns remaining.", tier: 8 },
  ...
  { id: "left_for_dead", name: "Left for Dead", description: "Can only capture leftward.", tier: 6 },
  ...
  { id: "fog_of_war_old", name: "Fog of War (extended)", description: "Hide opponent pieces entirely.", tier: 8, icon: "cloud-fog" },
  ...
  { id: "unlucky", name: "Unlucky", description: "Half the squares are unusable each turn, re-randomized.", tier: 7 },
  { id: "jumpy", name: "Jumpy", description: "When possible, must move an attacked piece.", tier: 5 },
  { id: "hopscotch", name: "Hopscotch", description: "Must alternate light/dark destination squares.", tier: 6 },
  { id: "leaps_and_bounds", name: "Leaps and Bounds", description: "Can't move a piece to a square adjacent to where it just was.", tier: 7 },
  { id: "colorblind", name: "Colorblind", description: "Can't move to one random color of squares, re-randomized each turn.", tier: 6 },
  ...
  { id: "reflective", name: "Reflective", description: "Each non-pawn move must land on a square whose point-symmetric partner (rotate 180 degrees through the board's center, e.g. a1 to h8) is occupied by a piece.", tier: 8 },
  ...
  { id: "leading_the_charge", name: "Leading the Charge", description: "As long as you have a knight, non-knights can't be ahead of your most advanced knight.", tier: 5 },
  { id: "active_volcano", name: "Active Volcano", description: "Can't move onto or orthogonally adjacent to a random square.", tier: 4 },
  { id: "nurturer", name: "Nurturer", description: "Can't capture the enemy king until you've promoted a pawn.", tier: 8 },
  { id: "prince_charming", name: "Prince Charming", description: "If your queen is attacked, must move a knight if possible.", tier: 3 },
  ...
  { id: "rook_fan_club", name: "Rook Fan Club", description: "Must promote to rooks. King/queen can't move diagonally.", tier: 6 },
  ...
  { id: "secret_garden", name: "Secret Garden", description: "Two random garden zones (each a 3-file-wide, 3-rank-deep block in front of one of your pawns, shown as marked squares) are off limits for the whole game: you can't move any piece onto those squares.", tier: 4 },
