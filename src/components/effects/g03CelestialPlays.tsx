...
export const PLAYS: Record<string, SigPlugin> = {
  hx4_the_bell_tolls: S(TotalityScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  ...
  bn4_clerical_error: S(AnalemmaScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_coronation_rest: S(NorthernCrownScene, { ordering: "radial", staggerMs: 60, victims: ["p"], hasLead: true, sound: "crownrain", anchor: "cast" }),
  bn4_furlough: S(WatchStarSetsScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  bn4_general_strike: S(StarTrailsHaltScene, { ordering: "octagon", staggerMs: 55, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  bn4_harvest_rest: S(HarvestMoonScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_hidden_stair: S(StarStairScene, { ordering: "line", staggerMs: 70, victims: ["k"], hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_hold_the_door: S(EarthShadowScene, { ordering: "line", staggerMs: 65, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  bn4_home_square: S(PoleStarScene, { ordering: "radial", staggerMs: 60, victims: ["k"], hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_listening_post: S(PulsarTickScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "blitz", anchor: "aim" }),
  bn4_paid_leave: S(MidnightSunScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  ...
  bn4_worry_beads: S(PleiadesScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  ...
  bn4_bottom_of_the_well: S(NoonStarScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_bribe_the_clerk: S(ZodiacBandScene, { ordering: "octagon", staggerMs: 55, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_dragonslayer: S(LunarNodeScene, { ordering: "radial", staggerMs: 60, victims: ["q"], hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_forty_winks: S(AlgolWinkScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  bn4_hermits_hour: S(ZodiacalLightScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_hush_money: S(GreenFlashScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "blitz", anchor: "cast" }),
  bn4_lone_crown: S(SolitaryStarScene, { ordering: "radial", staggerMs: 60, victims: ["k"], hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_over_the_shoulder: S(RetrogradeScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_over_the_wall: S(AuroraCurtainScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  bn4_pawns_ransom: S(StarRansomScene, { ordering: "radial", staggerMs: 60, victims: ["p"], hasLead: true, sound: "crownrain", anchor: "cast" }),
  bn4_rest_stop: S(SolsticeMarkScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_sparring_rhythm: S(RadiantScene, { ordering: "octagon", staggerMs: 60, victims: "all", hasLead: true, sound: "blitz", anchor: "cast" }),
};
