...
export const PLAYS: Record<string, SigPlugin> = {
  bn4_deck_of_kings: S(DeckOfKingsScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "coronation", anchor: "cast" }),
  ...
  ov_cartographers_vault: S(CartographersVaultScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "vault", anchor: "cast" }),
  ov_the_menu: S(TheMenuScene, { ordering: "file", staggerMs: 70, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  bn4_eye_of_ages: S(EyeOfAgesScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_feast_of_fools: S(FeastOfFoolsScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "coronation", anchor: "cast" }),
  hx4_broken_supply: S(BrokenSupplyScene, { ordering: "line", staggerMs: 65, victims: "all", hasLead: true, sound: "shades", anchor: "aim" }),
  ov_patch_notes: S(PatchNotesScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_all_seeing_spire: S(AllSeeingSpireScene, { ordering: "octagon", staggerMs: 55, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  bn4_ravens_court: S(RavensCourtScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  hx4_wax_seal: S(WaxSealScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  ...
  ov_season_pass: S(SeasonPassScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  hx4_dead_letter: S(DeadLetterScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  hx4_paper_orders: S(PaperOrdersScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "vault", anchor: "aim" }),
  ov_checkmate_rehearsal: S(CheckmateRehearsalScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  ov_upper_shelf: S(UpperShelfScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "vault", anchor: "cast" }),
  bn4_augurs_flight: S(AugursFlightScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "cathedral", anchor: "aim" }),
  bn4_season_ticket: S(SeasonTicketScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  ov_tasting_flight: S(TastingFlightScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  ov_ventriloquist: S(VentriloquistScene, { ordering: "line", staggerMs: 60, victims: ["n"], hasLead: true, sound: "shades", anchor: "aim" }),
  bn4_bakers_dozen: S(BakersDozenScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  bn4_punch_card: S(PunchCardScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  ov_focus_group: S(FocusGroupScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "coronation", anchor: "cast" }),
  bn4_coupon_book: S(CouponBookScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "vault", anchor: "cast" }),
};
