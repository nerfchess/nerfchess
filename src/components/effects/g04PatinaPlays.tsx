...
export const PLAYS: Record<string, SigPlugin> = {
  bn4_visor_down: S(VisorDownScene, { ordering: "octagon", staggerMs: 55, victims: ["k"], hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_angelus_bell: S(AngelusBellScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_barter_calm: S(BarterCalmScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "petrify", anchor: "cast" }),
  bn4_cold_compress: S(ColdCompressScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  bn4_dowagers_patience: S(DowagersPatienceScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "shades", anchor: "cast" }),
  bn4_ear_to_the_ground: S(EarToTheGroundScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "petrifiedforest", anchor: "aim" }),
  bn4_hourglass_flip: S(HourglassFlipScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  bn4_knights_vigil: S(KnightsVigilScene, { ordering: "octagon", staggerMs: 60, victims: ["n"], hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_measured_breath: S(MeasuredBreathScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  bn4_pawns_lullaby: S(PawnsLullabyScene, { ordering: "file", staggerMs: 80, victims: ["p"], hasLead: true, sound: "snooze", anchor: "cast" }),
  bn4_saints_day: S(SaintsDayScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  ...
  bn4_spring_in_the_step: S(SpringInTheStepScene, { ordering: "line", staggerMs: 70, victims: ["p"], hasLead: true, sound: "petrifiedforest", anchor: "aim" }),
  bn4_steady_hands: S(SteadyHandsScene, { ordering: "line", staggerMs: 60, victims: ["p"], hasLead: true, sound: "petrify", anchor: "aim" }),
  ...
  ov_loan_shark: S(LoanSharkScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  bn4_castle_quiet: S(CastleQuietScene, { ordering: "octagon", staggerMs: 55, victims: ["k", "r"], hasLead: true, sound: "petrifiedforest", anchor: "cast" }),
  bn4_check_valve: S(CheckValveScene, { ordering: "radial", staggerMs: 0, victims: ["k"], hasLead: true, sound: "petrify", anchor: "cast" }),
  bn4_crowned_calm: S(CrownedCalmScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_first_light: S(FirstLightScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "shades", anchor: "aim" }),
  bn4_grace_note: S(GraceNoteScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_kind_omen: S(KindOmenScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockice", anchor: "cast" }),
  bn4_morning_stretch: S(MorningStretchScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  bn4_promise_of_rest: S(PromiseOfRestScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "petrify", anchor: "aim" }),
  bn4_quiet_after: S(QuietAfterScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "petrify", anchor: "cast" }),
  bn4_shared_silence: S(SharedSilenceScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  bn4_small_ritual: S(SmallRitualScene, { ordering: "octagon", staggerMs: 60, victims: ["k"], hasLead: true, sound: "clockcage", anchor: "cast" }),
  bn4_two_breaths: S(TwoBreathsScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
};
