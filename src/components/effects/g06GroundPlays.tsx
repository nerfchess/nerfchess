...
export const PLAYS: Record<string, SigPlugin> = {
  ...
  bn4_coffee_break: S(QuakingBogScene, { ordering: "file", staggerMs: 70, victims: ["p"], hasLead: true, sound: "snooze", anchor: "board" }),
  ...
  hx4_fear_of_open_ground: S(ParedHeathScene, { ordering: "file", staggerMs: 75, victims: ["r"], hasLead: true, sound: "shades", anchor: "board" }),
  ...
  bn4_slow_doors: S(SnowCrustScene, { ordering: "file", staggerMs: 70, victims: ["p"], hasLead: true, sound: "massfreeze", anchor: "board" }),
  ...
  hx4_bridge_toll: S(RopeBridgeScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "clockcage", anchor: "board" }),
  hx4_clumsy_heralds: S(ScreeSlopeScene, { ordering: "line", staggerMs: 65, victims: "all", hasLead: true, sound: "rampage", anchor: "board" }),
  ...
  op_downtown_premium: S(RolledRoadScene, { ordering: "file", staggerMs: 65, victims: ["p"], hasLead: true, sound: "colossus", anchor: "board" }),
