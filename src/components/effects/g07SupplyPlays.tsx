...
export const PLAYS: Record<string, SigPlugin> = {
  op_homestead_clause: S(RationCartScene, { ordering: "file", staggerMs: 70, victims: ["p"], hasLead: true, sound: "vault", anchor: "cast" }),
  ...
  op_threshold_blessing: S(IssueBlanketScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "vault", anchor: "cast" }),
  op_trellis: S(LaundryLineScene, { ordering: "line", staggerMs: 80, victims: ["p"], hasLead: true, sound: "aegis", anchor: "aim" }),
  ov_masterclass: S(PaymasterScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "coinflip", anchor: "cast" }),
  ...
  bn4_muddy_boots: S(PicketLineScene, { ordering: "line", staggerMs: 55, victims: ["p"], hasLead: true, sound: "clockcage", anchor: "aim" }),
  bn4_pawn_umbrella: S(TentRaisedScene, { ordering: "radial", staggerMs: 55, victims: ["p"], hasLead: true, sound: "aegis", anchor: "cast" }),
  bn4_shoelace_knot: S(SackTieScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "clockcage", anchor: "cast" }),
  hx4_cold_porridge: S(ColdKettleScene, { ordering: "radial", staggerMs: 60, victims: ["p"], hasLead: true, sound: "snooze", anchor: "cast" }),
  hx4_heavy_pockets: S(HaversackScene, { ordering: "file", staggerMs: 60, victims: ["p"], hasLead: true, sound: "colossus", anchor: "cast" }),
  hx4_hopscotch: S(ChalkBoardScene, { ordering: "octagon", staggerMs: 55, victims: ["p"], hasLead: true, sound: "dice", anchor: "cast" }),
  hx4_polite_infantry: S(CounterFlapScene, { ordering: "file", staggerMs: 65, victims: ["p"], hasLead: true, sound: "petrify", anchor: "cast" }),
  op_airmail: S(PigeonLoftScene, { ordering: "line", staggerMs: 50, victims: "all", hasLead: true, sound: "blitz", anchor: "aim" }),
  ...
  op_bulk_postage: S(MailSackScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "slots", anchor: "aim" }),
  op_cellar_hatch: S(CellarHatchScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "vault", anchor: "cast" }),
  op_certified_letter: S(DespatchTinScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "gacha", anchor: "cast" }),
  ...
  op_express_courier: S(RemountScene, { ordering: "line", staggerMs: 55, victims: "all", hasLead: true, sound: "blitz", anchor: "aim" }),
