...
export const PLAYS: Record<string, SigPlugin> = {
  ...
  bn4_boundary_stones: S(BoundaryStonesScene, { ordering: "line", staggerMs: 90, victims: "all", hasLead: true, sound: "petrify", anchor: "board" }),
  ...
  bn4_doorstop: S(DoorstopScene, { ordering: "octagon", staggerMs: 60, victims: "all", hasLead: true, sound: "petrify", anchor: "board" }),
