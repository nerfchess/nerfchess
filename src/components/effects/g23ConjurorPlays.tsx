...
export const PLAYS: Record<string, SigPlugin> = {
  ...
  hx4_shadowed_meadow: S(ShadowedMeadowScene, { ordering: "sweep", staggerMs: 60, victims: "all", hasLead: true, sound: "shades", source: "blindfold", anchor: "cast" }),
  hx4_shrunken_shoes: S(ShrunkenShoesScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  ...
  op_champions_shades: S(ChampionsShadesScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  op_night_census: S(NightCensusScene, { ordering: "sweep", staggerMs: 45, victims: "all", hasLead: true, sound: "slots", anchor: "cast" }),
  op_night_court: S(NightCourtScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "wheel", anchor: "cast" }),
  op_night_custodian: S(NightCustodianScene, { ordering: "radial", staggerMs: 0, victims: ["r"], hasLead: true, sound: "vault", anchor: "cast" }),
  op_wrong_game_night: S(WrongGameNightScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "slots", anchor: "cast" }),
  ov_polite_cough: S(PoliteCoughScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "wheel", anchor: "cast" }),
};
