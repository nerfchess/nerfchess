...
function ChampionsRestScene({ role, delayMs }: SceneProps) {
  ...
  return (
    <Wide>
      ...
      <P x={50} y={52} w={24} h={24} cls="g01-tell" style={dm(delayMs, 0)}>
        <svg viewBox="0 0 100 100" className="block h-full w-full"><circle cx="50" cy="50" r="44" fill={C_CR.deep} stroke={C_CR.core} strokeWidth="5" /><path d="M50 10v7M90 50h-7M50 90v-7M10 50h7" stroke={C_CR.core} strokeWidth="5" {...SJ} /></svg>
      </P>
      <P x={50} y={52} w={19} h={19} cls="g01-cr-hands" style={dm(delayMs, 150)}>
        <svg viewBox="0 0 90 90" className="block h-full w-full"><path d="M45 45L20 34M45 45l26-9" fill="none" stroke={C_CR.glow} strokeWidth="6" {...SJ} /><circle cx="45" cy="45" r="5" fill={C_CR.glow} /></svg>
      </P>
      <P x={50} y={50} w={20} h={9} cls="g01-cr-sag" style={dm(delayMs, 320)}>
        <svg viewBox="0 0 100 46" className="block h-full w-full"><path d="M4 6q46 44 92 0" fill="none" stroke={C_CR.glow} strokeWidth="7" {...SJ} /><path d="M22 22q24 16 48-2" fill="none" stroke={C_CR.core} strokeWidth="5" {...SJ} /></svg>
      </P>
      <P x={58} y={40} w={7} h={7} cls="g01-flash" style={dm(delayMs, 520)}>
        <svg viewBox="0 0 40 40" className="block h-full w-full"><path d="M8 30h14L8 14h14" fill="none" stroke={C_CR.glow} strokeWidth="4" {...SJ} /></svg>
      </P>
  ...
  return (
    <Wide>
      ...
      <P x={50} y={58} w={20} h={17} cls="g01-tell" style={dm(delayMs, 0)}>
        <svg viewBox="0 0 100 84" className="block h-full w-full"><rect x="6" y="10" width="88" height="68" fill={C_DH.deep} stroke={C_DH.core} strokeWidth="6" /><rect x="34" y="18" width="32" height="8" fill={C_DH.core} /><circle cx="50" cy="52" r="14" fill="none" stroke={C_DH.core} strokeWidth="5" /></svg>
      </P>
      <P x={50} y={42} w={9} h={14} cls="g01-dh-card" style={dm(delayMs, 170)}>
        <svg viewBox="0 0 46 70" className="block h-full w-full"><rect x="3" y="3" width="40" height="64" fill={C_DH.glow} stroke={C_DH.deep} strokeWidth="4" /><path d="M9 16h28M9 26h28M9 36h28" stroke={C_DH.deep} strokeWidth="3" /></svg>
      </P>
      <P x={50} y={51} w={13} h={5} cls="g01-dh-punch" style={dm(delayMs, 340)}>
        <svg viewBox="0 0 70 26" className="block h-full w-full" preserveAspectRatio="none"><rect x="2" y="2" width="66" height="22" fill={C_DH.core} stroke={C_DH.deep} strokeWidth="4" /></svg>
      </P>
      {[0, 1].map((i) => (
  ...
  return (
    <Wide>
      ...
      <P x={50} y={44} w={11} h={7} cls="g01-ea-cuff" style={dm(delayMs, 160)}>
        <svg viewBox="0 0 56 36" className="block h-full w-full"><path d="M6 32a22 22 0 0 1 44 0" fill="none" stroke={C_EA.glow} strokeWidth="8" {...SJ} /></svg>
      </P>
      <P x={50} y={56} w={15} h={15} cls="g01-ea-slip" style={dm(delayMs, 300)}>
        <svg viewBox="0 0 70 70" className="block h-full w-full"><circle cx="35" cy="38" r="28" fill={C_EA.deep} stroke={C_EA.core} strokeWidth="6" /><path d="M35 38V20M35 38l13 8" fill="none" stroke={C_EA.glow} strokeWidth="5" {...SJ} /><rect x="30" y="2" width="10" height="8" fill={C_EA.core} /></svg>
      </P>
      <P x={50} y={44} w={12} h={7} cls="g01-flash" style={dm(delayMs, 460)}>
        <svg viewBox="0 0 60 36" className="block h-full w-full"><path d="M8 30a22 22 0 0 1 44 0" fill="none" stroke={C_EA.core} strokeWidth="6" strokeDasharray="7 8" {...SJ} /></svg>
      </P>
    ...
    <Wide>
      ...
      {[0, 1, 2].map((i) => (
        <P key={i} x={36} y={42 - i * 4} w={8} h={4} cls="g01-gb-weight" style={sv(dm(delayMs, 280 + i * 110), { "--g01-dy": "-260%" })}>
          <svg viewBox="0 0 40 20" className="block h-full w-full" preserveAspectRatio="none"><path d="M8 2h24l6 16H2z" fill={C_GB.glow} stroke={C_GB.deep} strokeWidth="3" {...SJ} /></svg>
        </P>
      ))}
      <P x={64} y={54} w={16} h={11} cls="g01-gb-keep" style={dm(delayMs, 600)}>
        <svg viewBox="0 0 80 56" className="block h-full w-full"><rect x="4" y="14" width="22" height="34" rx="1" fill={C_GB.deep} stroke={C_GB.core} strokeWidth="4" transform="rotate(-14 15 31)" /><rect x="29" y="10" width="22" height="34" rx="1" fill={C_GB.glow} stroke={C_GB.deep} strokeWidth="4" /><rect x="54" y="14" width="22" height="34" rx="1" fill={C_GB.deep} stroke={C_GB.core} strokeWidth="4" transform="rotate(14 65 31)" /></svg>
      </P>
  ...
  return (
    <Wide>
      ...
      <P x={50} y={50} w={24} h={24} cls="g01-tell" style={dm(delayMs, 0)}>
        <svg viewBox="0 0 100 100" className="block h-full w-full"><circle cx="50" cy="50" r="44" fill={C_JB.deep} stroke={C_JB.core} strokeWidth="6" /><path d="M50 44V22" stroke={C_JB.glow} strokeWidth="5" {...SJ} /></svg>
      </P>
      {JB_NUMS.map((m, i) => (
      ...
      <P x={50} y={50} w={20} h={20} cls="g01-jb-spin" style={dm(delayMs, 470)}>
        <svg viewBox="0 0 100 100" className="block h-full w-full"><circle cx="50" cy="50" r="38" fill="none" stroke={C_JB.glow} strokeWidth="5" /><path d="M50 50V20M50 50l16 12" fill="none" stroke={C_JB.core} strokeWidth="5" {...SJ} /></svg>
      </P>
...
function MoonlitReprieveScene({ role, delayMs }: SceneProps) {
  ...
  return (
    <Wide>
      ...
      <P x={50} y={52} w={24} h={24} cls="g01-tell" style={dm(delayMs, 0)}>
        <svg viewBox="0 0 100 100" className="block h-full w-full"><circle cx="50" cy="50" r="44" fill={C_MR.deep} stroke={C_MR.core} strokeWidth="6" /><path d="M50 8v8M92 50h-8M50 92v-8M8 50h8" stroke={C_MR.core} strokeWidth="5" {...SJ} /></svg>
      </P>
      <P x={50} y={62} w={22} h={13} cls="g01-mr-tide" style={dm(delayMs, 180)}>
        <svg viewBox="0 0 110 64" className="block h-full w-full" preserveAspectRatio="none"><path d="M0 16q14 12 28 0t28 0 28 0 28 0v48H0z" fill={C_MR.core} opacity="0.9" /></svg>
      </P>
      <P x={50} y={54} w={9} h={7} cls="g01-mr-boat" style={dm(delayMs, 320)}>
        <svg viewBox="0 0 50 36" className="block h-full w-full"><path d="M4 22h42l-8 12H12z" fill={C_MR.glow} stroke={C_MR.deep} strokeWidth="3" {...SJ} /><path d="M25 22V2l14 14z" fill={C_MR.glow} stroke={C_MR.deep} strokeWidth="3" {...SJ} /></svg>
      </P>
