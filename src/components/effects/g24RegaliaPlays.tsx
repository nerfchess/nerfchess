...
export const PLAYS: Record<string, SigPlugin> = {
  ...
  bn4_crown_of_masks: S(CrownOfMasksScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "crownrain", anchor: "cast" }),
  hx4_crown_of_lead: S(CrownOfLeadScene, { ordering: "radial", staggerMs: 60, victims: ["k"], hasLead: true, sound: "colossus", anchor: "cast" }),
  ov_crown_of_the_undying: S(CrownOfTheUndyingScene, { ordering: "octagon", staggerMs: 55, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  bn4_crown_commission: S(CrownCommissionScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "vault", anchor: "cast" }),
  ...
  hx4_crown_malaise: S(CrownMalaiseScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "cathedral", anchor: "cast" }),
  hx4_grim_procession: S(GrimProcessionScene, { ordering: "radial", staggerMs: 70, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  hx4_royal_quarantine: S(RoyalQuarantineScene, { ordering: "octagon", staggerMs: 60, victims: ["k"], hasLead: true, sound: "wall", anchor: "cast" }),
  ...
  bn4_royal_banquet: S(RoyalBanquetScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "crownrain", anchor: "cast" }),
  bn4_royal_barge: S(RoyalBargeScene, { ordering: "line", staggerMs: 60, victims: ["q"], hasLead: true, sound: "coronation", anchor: "aim" }),
  hx4_rusted_crown: S(RustedCrownScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "wall", anchor: "cast" }),
  ...
  hx4_summons_to_court: S(SummonsToCourtScene, { ordering: "radial", staggerMs: 65, victims: "all", hasLead: true, sound: "colossus", anchor: "cast" }),
