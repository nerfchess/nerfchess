...
export const PLAYS: Record<string, SigPlugin> = {
  ...
  op_meet_kevin: S(MeetKevinScene, { ordering: "radial", staggerMs: 60, victims: ["p"], hasLead: true, sound: "coronation", anchor: "cast" }),
  op_nesting_doll: S(NestingDollScene, { ordering: "line", staggerMs: 80, victims: ["p"], hasLead: true, sound: "cathedral", anchor: "aim" }),
  op_opposition_research: S(OppositionResearchScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "siege", anchor: "aim" }),
  op_penny_slots: S(PennySlotsScene, { ordering: "radial", staggerMs: 60, victims: ["p"], hasLead: true, sound: "blitz", anchor: "cast" }),
  op_plush_pony: S(PlushPonyScene, { ordering: "line", staggerMs: 75, victims: ["n"], hasLead: true, sound: "siege", anchor: "aim" }),
  op_price_check: S(PriceCheckScene, { ordering: "sweep", staggerMs: 55, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  op_prophecy_fulfilled: S(ProphecyFulfilledScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "coronation", anchor: "aim" }),
  op_regina_dossier: S(ReginaDossierScene, { ordering: "radial", staggerMs: 60, victims: ["q"], hasLead: true, sound: "coronation", anchor: "cast" }),
  op_roof_pigeon: S(RoofPigeonScene, { ordering: "radial", staggerMs: 65, victims: ["r"], hasLead: true, sound: "blitz", anchor: "cast" }),
  op_sampler_platter: S(SamplerPlatterScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "crownrain", anchor: "cast" }),
  op_second_harvest: S(SecondHarvestScene, { ordering: "line", staggerMs: 80, victims: ["p"], hasLead: true, sound: "crownrain", anchor: "aim" }),
  op_special_order: S(SpecialOrderScene, { ordering: "sweep", staggerMs: 60, victims: "all", hasLead: true, sound: "coronation", anchor: "cast" }),
  op_store_credit: S(StoreCreditScene, { ordering: "line", staggerMs: 75, victims: "all", hasLead: true, sound: "crownrain", anchor: "aim" }),
  op_tango_dip: S(TangoDipScene, { ordering: "line", staggerMs: 80, victims: ["k"], hasLead: true, sound: "blitz", anchor: "aim" }),
  op_transfer_window: S(TransferWindowScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "wall", anchor: "aim" }),
  op_tripwire_bell: S(TripwireBellScene, { ordering: "line", staggerMs: 70, victims: "all", hasLead: true, sound: "siege", anchor: "aim" }),
  op_understudy_list: S(UnderstudyListScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  ov_coupon: S(CouponScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "crownrain", anchor: "cast" }),
  ...
  ov_window_shopping: S(WindowShoppingScene, { ordering: "sweep", staggerMs: 60, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
};
