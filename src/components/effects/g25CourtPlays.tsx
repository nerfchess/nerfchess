...
export const PLAYS: Record<string, SigPlugin> = {
  ...
  hx4_the_quarrel: S(QuarrelScene, { ordering: "radial", staggerMs: 70, victims: ["k", "q"], hasLead: true, sound: "shades", anchor: "board" }),
  hx4_thistle_crown: S(ThistleCrownScene, { ordering: "octagon", staggerMs: 65, victims: ["k"], hasLead: true, sound: "cathedral", anchor: "cast" }),
  hx4_wilted_garland: S(WiltedGarlandScene, { ordering: "line", staggerMs: 70, victims: ["q"], hasLead: true, sound: "shades", anchor: "board" }),
  ...
  ov_counterfeit_crown: S(PlaceCardsScene, { ordering: "radial", staggerMs: 70, victims: ["k", "q"], hasLead: true, sound: "slots", anchor: "board" }),
  ...
  op_crown_indemnity: S(BackingOutScene, { ordering: "line", staggerMs: 70, victims: ["p"], hasLead: true, sound: "cathedral", anchor: "board" }),
  ov_velcro_gloves: S(VelcroGlovesScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "slots", anchor: "aim" }),
  bn4_paper_crown: S(FoolTumblesScene, { ordering: "radial", staggerMs: 55, victims: ["k"], hasLead: true, sound: "crownrain", anchor: "board" }),
