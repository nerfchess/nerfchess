...
export const PLAYS: Record<string, SigPlugin> = {
  bn4_window_shopping: S(WindowShoppingScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "vault", anchor: "cast" }),
  op_bumper_crop: S(BumperCropScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  op_sunwise_turn: S(SunwiseTurnScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  op_widdershins: S(WiddershinsScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  ov_broom_sweep: S(BroomSweepScene, { ordering: "line", staggerMs: 70, victims: ["p"], hasLead: true, sound: "wall", anchor: "aim" }),
  ov_free_sample: S(FreeSampleScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "shades", anchor: "aim" }),
  ov_loot_filter: S(LootFilterScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  ov_molting_season: S(MoltingSeasonScene, { ordering: "radial", staggerMs: 0, victims: ["b"], hasLead: true, sound: "shades", anchor: "cast" }),
  ov_slingshot: S(SlingshotScene, { ordering: "line", staggerMs: 60, victims: ["p"], hasLead: true, sound: "shades", anchor: "aim" }),
  bn4_watchmans_lantern: S(WatchmansLanternScene, { ordering: "line", staggerMs: 65, victims: "all", hasLead: true, sound: "cathedral", anchor: "aim" }),
  hx4_red_tape: S(RedTapeScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  op_alarm_lantern: S(AlarmLanternScene, { ordering: "radial", staggerMs: 60, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  op_back_to_school: S(BackToSchoolScene, { ordering: "radial", staggerMs: 0, victims: ["b"], hasLead: true, sound: "snooze", anchor: "cast" }),
  op_border_stamp: S(BorderStampScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "vault", anchor: "cast" }),
  op_chaperone: S(ChaperoneScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "vault", anchor: "cast" }),
  op_choir_wings: S(ChoirWingsScene, { ordering: "radial", staggerMs: 0, victims: ["b"], hasLead: true, sound: "cathedral", anchor: "cast" }),
  op_compost_heap: S(CompostHeapScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  op_early_sprout: S(EarlySproutScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  op_general_delivery: S(GeneralDeliveryScene, { ordering: "line", staggerMs: 60, victims: ["p"], hasLead: true, sound: "shades", anchor: "aim" }),
  op_hearth_blessing: S(HearthBlessingScene, { ordering: "radial", staggerMs: 55, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  op_intermission: S(IntermissionScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  op_late_bloom: S(LateBloomScene, { ordering: "radial", staggerMs: 0, victims: ["q"], hasLead: true, sound: "vault", anchor: "cast" }),
  op_layaway_plan: S(LayawayPlanScene, { ordering: "radial", staggerMs: 0, victims: "all", hasLead: true, sound: "clockcage", anchor: "cast" }),
  ...
  op_lucky_stirrup: S(LuckyStirrupScene, { ordering: "radial", staggerMs: 0, victims: ["n"], hasLead: true, sound: "snooze", anchor: "cast" }),
};
