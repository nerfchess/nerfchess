...
export const PLAYS: Record<string, SigPlugin> = {
  hx4_echo_chamber: S(EchoChamberScene, { ordering: "radial", staggerMs: 70, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  hx4_iron_ring: S(IronRingScene, { ordering: "octagon", staggerMs: 55, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  ...
  hx4_sealed_meridian: S(SealedMeridianScene, { ordering: "file", staggerMs: 70, victims: "all", hasLead: true, sound: "wall", anchor: "cast" }),
  ov_terraform: S(TerraformScene, { ordering: "radial", staggerMs: 80, victims: "all", hasLead: true, sound: "petrify", anchor: "cast" }),
  bn4_sting_of_the_wasp: S(StingOfTheWaspScene, { ordering: "line", staggerMs: 55, victims: "all", hasLead: true, sound: "blitz", anchor: "aim" }),
  hx4_signal_jam: S(SignalJamScene, { ordering: "file", staggerMs: 65, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  bn4_keep_gate: S(KeepGateScene, { ordering: "line", staggerMs: 75, victims: ["k"], hasLead: true, sound: "petrifiedforest", anchor: "cast" }),
  ...
  hx4_no_homecoming: S(NoHomecomingScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "shades", anchor: "cast" }),
  hx4_no_return: S(NoReturnScene, { ordering: "line", staggerMs: 60, victims: "all", hasLead: true, sound: "petrify", anchor: "aim" }),
  hx4_tar_pits: S(TarPitsScene, { ordering: "radial", staggerMs: 80, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  hx4_fresh_crater: S(FreshCraterScene, { ordering: "octagon", staggerMs: 60, victims: "all", hasLead: true, sound: "petrifiedforest", anchor: "cast" }),
  hx4_prowlers_bell: S(ProwlersBellScene, { ordering: "radial", staggerMs: 70, victims: "all", hasLead: true, sound: "cathedral", anchor: "cast" }),
  hx4_bramble_patch: S(BramblePatchScene, { ordering: "radial", staggerMs: 85, victims: "all", hasLead: true, sound: "petrifiedforest", anchor: "cast" }),
  ...
  hx4_gnat_cloud: S(GnatCloudScene, { ordering: "radial", staggerMs: 45, victims: "all", hasLead: true, sound: "snooze", anchor: "cast" }),
  ...
  bn4_garden_fence: S(GardenFenceScene, { ordering: "line", staggerMs: 70, victims: ["p"], hasLead: true, sound: "petrifiedforest", anchor: "cast" }),
  ...
  op_garden_gate: S(GardenGateScene, { ordering: "radial", staggerMs: 0, victims: ["p"], hasLead: true, sound: "petrifiedforest", anchor: "cast" }),
