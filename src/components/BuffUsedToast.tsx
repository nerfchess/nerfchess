...
export function BuffUsedToast({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="pointer-events-none fixed right-3 top-[var(--opp-plays-top,4rem)] z-[39] w-[min(80vw,20rem)] animate-rise border border-gold/40 bg-ink-700/95 p-3 shadow-plate"
    >
