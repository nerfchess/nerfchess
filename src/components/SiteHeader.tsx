  ...
  return (
    <nav className="flex items-center justify-between gap-3 px-5 sm:px-10 py-5 sm:py-6">
      ...
      <div ref={rightRef} className="relative flex items-center gap-0.5 sm:gap-1">
        ...
        {menu === "search" && (
          <div className="absolute right-0 top-full z-40 mt-3 w-72 plate p-3 shadow-2xl">
            <PlayerSearch />
        ...
        {user && (
          <>
            ...
            {menu === "challenges" && (
              <div className="absolute right-0 top-full z-40 mt-3 w-80 plate shadow-2xl">
        ...
        {user === undefined ? (
          ...
          <>
            ...
            {menu === "profile" && (
              <div className="absolute right-0 top-full z-40 mt-3 w-56 plate py-1 shadow-2xl">
                <MenuItem
                  icon={<User size={14} />}
                  label="Profile"
                  onClick={() => {
